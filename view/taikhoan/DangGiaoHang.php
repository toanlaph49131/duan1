...
<div class="container-tk">
    ...
    <div class="box-tk-left">
        ...
        <div class="box-tk tt" id="tt2">
            ...
            <a href="?act=choXacNhan"><button class="btndh">Chờ xác nhận</button></a>
            <a href="?act=DaXacNhan"><button class="btndh">Đã xác nhận</button></a>
            <a href="?act=DangGiaoHang"><button class="btndh">Đang giao hàng</button></a>
            <a href="?act=GiaoHangThanhCong"><button class="btndh">Giao hàng thành công</button></a>
            <a href="?act=DaHuy"><button class="btndh">Đã hủy</button></a>
